...
export const MOCK_LANDING_FILMS: FilmTMDB[] = [
  {
    ...
    genre_ids: [3, 4],
    overview:
      'Sebastian and Mia are drawn together by their common desire to do what they love. But as success mounts they are faced with decisions that begin to fray the fragile fabric of their love affair.',
...
export const TREES_MOCK_MCU: FilmTMDB[] = [
  {
    id: 1,
    title: 'Iron Man',
    vote_average: 7.9,
  ...
  },
  {
    ...
    genre_ids: [28, 12, 878],
    overview:
      'Scientist Bruce Banner scours the planet for an antidote to the gamma radiation that infected his cells and turned him into the Hulk.',
    poster_path: '/assets/images/dune.webp',
    adult: false,
    backdrop_path: '',
    original_language: 'en',
  ...
  },
  {
    ...
    genre_ids: [28, 12, 878],
    overview:
      'With the world now aware of his identity as Iron Man, Tony Stark must contend with both his declining health and a vengeful mad scientist.',
    poster_path: '/assets/images/every.webp',
    adult: false,
    backdrop_path: '',
    original_language: 'en',
  ...
  },
  {
    ...
    genre_ids: [28, 12, 14],
    overview:
      'The powerful but arrogant Thor is cast out of Asgard to live amongst humans on Earth, where he soon becomes one of their finest defenders.',
    poster_path: '/assets/images/spider.webp',
    adult: false,
    backdrop_path: '',
    original_language: 'en',
  ...
  },
  {
    ...
    genre_ids: [28, 12, 878],
    overview:
      'Nick Fury of S.H.I.E.L.D. assembles a team of superhumans to save the world from Loki and his army.',
    poster_path: '/assets/images/interestellar.webp',
    adult: false,
    backdrop_path: '',
    original_language: 'en',
  ...
  },
  {
    ...
    genre_ids: [28, 12, 878],
    overview:
      'When Tony Stark tries to jumpstart a peacekeeping program, things go awry and Earth’s Mightiest Heroes are put to the ultimate test.',
    poster_path: '/assets/images/interestellar.webp',
    adult: false,
    backdrop_path: '',
    original_language: 'en',
  ...
  },
  {
    ...
    genre_ids: [878, 28, 12],
    overview:
      'Armed with the astonishing ability to shrink in scale but increase in strength, master thief Scott Lang must embrace his inner-hero and help his mentor.',
    poster_path: '/assets/images/dune.webp',
    adult: false,
    backdrop_path: '',
    original_language: 'en',
...
export const TREES_MOCK_STARWARS: FilmTMDB[] = [
  {
    id: 11,
    title: 'Star Wars',
    vote_average: 8.2,
  ...
  },
  {
    ...
    genre_ids: [12, 28, 878],
    overview:
      'Luke Skywalker leads a mission to rescue his friend Han Solo from the clutches of Jabba the Hutt, while the Emperor seeks to destroy the Rebellion once and for all.',
    poster_path: '/assets/images/every.webp',
    adult: false,
    backdrop_path: '',
    original_language: 'en',
  ...
  },
  {
    ...
    genre_ids: [12, 28, 878],
    overview: 'Anakin Skywalker, a young slave strong with the Force, is discovered on Tatooine.',
    poster_path: '/assets/images/spider.webp',
    adult: false,
    backdrop_path: '',
    original_language: 'en',
  ...
  },
  {
    ...
    genre_ids: [12, 28, 878],
    overview:
      'Following an assassination attempt on Senator Padmé Amidala, Jedi Knights Anakin Skywalker and Obi-Wan Kenobi investigate a mysterious plot.',
    poster_path: '/assets/images/lalaland.webp',
    adult: false,
    backdrop_path: '',
    original_language: 'en',
  ...
  },
  {
    ...
    genre_ids: [878, 12, 28],
    overview:
      'Through a series of daring escapades deep within a dark and dangerous criminal underworld, Han Solo meets his mighty future copilot Chewbacca.',
    poster_path: '/assets/images/lalaland.webp',
    adult: false,
    backdrop_path: '',
    original_language: 'en',

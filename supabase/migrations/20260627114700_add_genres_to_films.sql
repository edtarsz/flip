ALTER TABLE public.films ADD COLUMN IF NOT EXISTS genre_ids integer[] DEFAULT '{}';

DROP FUNCTION IF EXISTS public.add_to_watchlist_with_film(bigint, text, text, real, text, uuid);
